...
ResourceArray::ResourceArray(int caffeine, int lab, int lecture, int study, int tutorial) {
  resources[Resource::CAFFEINE] = caffeine;
  resources[Resource::LAB] = lab;
  resources[Resource::LECTURE] = lecture;
  resources[Resource::STUDY] = study;
  resources[Resource::TUTORIAL] = tutorial;
}

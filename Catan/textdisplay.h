...
private:
  ...
  std::vector<std::vector<std::vector<int>>>
      studentCriteria; // Criteria for each student: Settlement, City, Exam
  std::vector<std::string> boardRoads;    // Board Roads
  ...
  int robberPos;                           // Position of robber on the board
...
public:
  ...
  std::string formatRoad(int index) const;
  ...
  void notify(Subject<RoadState> &whoFrom) override;
  ...
  void promptInitialSettlement() const;       // Prompt for initial Settlement
  ...
  void displayRobberRoll(
      const std::vector<Colour> students,
      const std::vector<ResourceArray> lost) const; // Display robber roll
